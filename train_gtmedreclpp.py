...
Geometry-Tolerant Structure-Appearance Med-ReCL++ 训练入口。

这份脚本只负责“实验流程编排”，真正的网络结构、数据集、损失函数、
矩传播不确定性计算和 MC Dropout 对照都定义在
model_attnres3d_gtmedreclpp.py 中。
...
import model_attnres3d_gtmedreclpp as net
...
def main():
    ...
    parser.add_argument("--medrecl_lambda_x", type=float, default=0.0,
                        help="CT弱正样本权重；GT-MedReCL++主线默认关闭，仅用于消融")
    ...
    print("方法版本: GT-MedReCL++ (soft-positive + FN suppression + EMA structure/appearance)")
    print(
        "GT-MedReCL++ 参数: "
